...
This directory contains all source code for the CDQN project.

The structure of this directory directly reflects the **C/U/K architectural model** outlined in the project's documentation:
