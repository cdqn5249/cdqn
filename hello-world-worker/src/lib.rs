...
wit_bindgen::generate!({
    ...
    // The world path is now in the format `package-name/interface-name`.
    world: "local:hello-world/worker",
});

// We define a struct that will hold our component's implementation.
struct MyWorker;

// This is the crucial part. We implement the `worker` trait, which was
// automatically generated by `wit-bindgen` from our `interface worker`.
// The name of the trait matches the name of the interface.
