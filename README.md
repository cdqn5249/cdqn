...
CDQN (**C**hained and **D**istributed **Q**uang **N**umbers) is an open research project exploring a new computational abstraction layer designed from the perspective of modern computing hardware rather than inherited mathematical notation or legacy software stacks.
