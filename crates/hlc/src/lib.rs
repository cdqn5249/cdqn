...
//!
//! This crate provides a minimal, thread-safe HLC implementation.
//! Serialization support via `serde` is available as an optional feature
//! for use in other CDQN crates like `cdu`.
...
// Conditionally import serde traits only when the "serde" feature is enabled.
#[cfg(feature = "serde")]
use serde::{Deserialize, Serialize};

/// A Hybrid Logical Clock timestamp.
/// This struct can be serialized if the "serde" feature is enabled on the crate.
